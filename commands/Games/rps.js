...
module.exports.run = async (Client, message, args, prefix) => {
   ...
   const botChoice = Math.floor(Math.random() * 2) + 1 //Random numeber between 1 and 3.
    let botEmoji;
    let playerEmoji;
    let botChoiceStr;
    ...
    if (args[0] == 'rock') {
      ...
      else return message.channel.send(`I picked: ${botEmoji}, you pickedL ${playerEmoji}. You won.`);
