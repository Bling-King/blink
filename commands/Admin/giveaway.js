...
module.exports.run = async (Client, message, args, prefix) => { // thats for my cmd handler
    ...
    if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.reply("You don't have permission to use this command!");
...
module.exports.help = {
    name: "giveaway",
    aliases: ["g-start", 'giveaway-start', 'Giveaway']
}