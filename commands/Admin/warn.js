...
module.exports.run = async (Client, message, args, prefix) => {
  ...
  if(!message.member.hasPermission("ADMINISTRATOR")) {
    ...
    if(!user) {
      return message.channel.send("Please Mention the person to who you want to warn - m.warn @mention <reason>")
    }
    ...
    if(user.id === message.guild.owner.id) {
      return message.channel.send("You cannot warn an owner")
    }
